...
do
  ...
  -- Close current buffer while preserving window layout
  ...
  -- Force hjkl by disabling arrow keys in normal/visual mode
...
do
  ...
  -- [[ Colorscheme ]]
  -- See `:Telescope colorscheme` for what's installed.
...
-- Loads everything in lua/custom/plugins/*.lua
-- ============================================================
do
